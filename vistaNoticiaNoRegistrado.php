			...
			<div id="contenedorNoticias">
				<div id="noticia" class="vistaNoticia">
					...
					<div id = "datosNoticia" class="datosVista">	
						<span class="datos">por: <a href="">Nick</a> <hr/> <!--enlace a comunidadNoRegistrado.html o usuario.html a registrarse-->
					...
					<div id="contenedorComentarios">
						...
						<div id="comentar" class="comentario">
							...
							<div id="infoComentario">
								...
								<a href="">Carlos Jaynor</a> <!--enlace a comunidadNoRegistrado.html o usuario.html a registrarse-->
								<p>2 abril, 2015 at 21:29</p>
							</div>
							
							<div id="estiloComentario">
								<p>HOLAAAAA bla bla bla blaa blablabla bla bla bla bla bla blaa blablabla bla 
						...
						<div id="comentar" class="comentario">
							...
							<div id="infoComentario">
								...
								<a href="">Claudio60</a> <!--enlace a comunidadNoRegistrado.html o usuario.html a registrarse-->
