	...
	<body>
		<div id="contenedor">
			...
			<div id="contenidoCentral">
				<br>
				<img id ="slide" src="img/civilWar.jpg" /><br><br>
				<div id="tituloCentro">
				<h1>OFERTAS</h1>
					
					<div class="columna">
						<div class="imagenes"><img src="img/peliStarWars.png" width="100" height="133" /></div>
						<div class="precios"><a href="vistaCompra.php"><span class="titulo">Pack Star Wars</span></a><br><br>
			...
			<h2>USUARIO</h2>
				<img src="img/usuarioTrans.png" width="80" height="80" />
				<form action="portadaUserRegistrado.php" method="post">
					<fieldset>
						<input required="required" name="nombre" maxlength="50" type="text" placeholder="nick"><br><br>
						<input required="required" name="password" maxlength="50" type="password" placeholder="contraseña"><br><br>
